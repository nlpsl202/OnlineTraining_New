var aEnrichPathName = document.location.pathname.split('/'); var aEnrichPath = "http://" + document.location.host + "/" + aEnrichPathName[1] + "/Utility/"; "undefined" === typeof jwplayer && (jwplayer = function () { if (jwplayer.api) return jwplayer.api.selectPlayer.apply(this, arguments) }, jwplayer.version = "6.12.4956", jwplayer.vid = document.createElement("video"), jwplayer.audio = document.createElement("audio"), jwplayer.source = document.createElement("source"), function () {
    ...
    b.repo = function () { var a = aEnrichPath; try { b.isHTTPS() && (a = a.replace("http://", "https://ssl.")) } catch (c) { } return a }; b.versionCheck = function (a) { a = ("0" + a).split(/\W/); var c = f.version.split(/\W/), b = parseFloat(a[0]), d = parseFloat(c[0]); return b > d || b === d && parseFloat("0" + a[1]) > parseFloat(c[1]) ? !1 : !0 }; b.ajax = function (a, c, d, g) {
